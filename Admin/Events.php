...
if(isset($_POST['save'])){
  ...
  $Description=$_POST['Description'];
    ...
    $query=mysqli_query($conn,"INSERT into events(EventName,Date,Time,Venue,Description) 
    value('$EventName','$Date','$Time','$Venue','$Description')");

if ($query) {
  $statusMsg = "<div id='statusMsg' class='alert alert-success' style='margin-right:700px;'>Event Created Successfully!</div>";
} else {
...
//--------------------EDIT------------------------------------------------------------
 ...
 if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "edit")
    ...
    $query=mysqli_query($conn,"update events set EventName='$EventName', Date='$Date', Time='$Time', Venue='$Venue', Description='$Description'
    where Id='$Id'");
            if ($query) {
