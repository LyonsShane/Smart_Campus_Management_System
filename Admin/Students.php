...
if(isset($_POST['save'])){
  ...
  $dateCreated = date("Y-m-d");
    ...
    $query=mysqli_query($conn,"INSERT into students(firstName,lastName,emailAddress,password,phoneNo,Address,Gender,AdmissionNumber,EnrolledCourse,dateCreated) 
    value('$firstName','$lastName','$emailAddress','$sampPass_2','$phoneNo','$Address','$Gender','$AdmissionNumber','$EnrolledCourse','$dateCreated')");

    if ($query) {
                
                $statusMsg = "<div id='statusMsg' class='alert alert-success'  style='margin-right:700px;'>Student Created Successfully!</div>";
    }
            else
            {
...
//--------------------EDIT------------------------------------------------------------
 ...
 if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "edit")
    ...
    emailAddress='$emailAddress',phoneNo='$phoneNo', Address='$Address', Gender='$Gender', AdmissionNumber='$AdmissionNumber', EnrolledCourse='$EnrolledCourse'
    where Id='$Id'");
            if ($query) {
