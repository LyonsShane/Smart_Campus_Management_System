      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <div class="row mb-3">
            <!-- Courses Card -->
          <?php 
$query1=mysqli_query($conn,"SELECT * from courses");                       
...
?>
            ...
            <!-- Batches Card -->
          <?php 
$query1=mysqli_query($conn,"SELECT * from batches");                       
$batches = mysqli_num_rows($query1);
?>
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-uppercase mb-1">Batches</div>
                      <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo $batches;?></div>
                      <div class="mt-2 mb-0 text-muted text-xs">
                        <!-- <span class="text-success mr-2"><i class="fas fa-arrow-up"></i> 20.4%</span>
                        <span>Since last month</span> -->
                      </div>
                    ...
                    <div class="col-auto">
                      <i class="fa fa-th fa-2x text-secondary"></i>
                    </div>
                  </div>
                </div>
              </div>
...
?>
            ...
            <!-- Lecturers Card  -->
            <?php 
            $query1=mysqli_query($conn,"SELECT * from lecturers");                       
            $lecturers = mysqli_num_rows($query1);
            ?>
                        <div class="col-xl-3 col-md-6 mb-4">
                          <div class="card h-100">
                            <div class="card-body">
                              <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                  ...
                                  <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $lecturers;?></div>
                                  <div class="mt-2 mb-0 text-muted text-xs">
                                    <!-- <span class="text-success mr-2"><i class="fas fa-arrow-up"></i> 12%</span>
                                    <span>Since last years</span> -->
                                  </div>
...
$Workshops = mysqli_num_rows($query1);
?>
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-uppercase mb-1">Workshops</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $Workshops;?></div>
                      <div class="mt-2 mb-0 text-muted text-xs">
        ...
        <div class="row">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Recently Engaged Students</h6>
                </div>
            ...
            <div class="row">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Recently Registerd Lecturers</h6>
                </div>
                <div class="table-responsive p-3">
                  <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                    <thead class="thead-light">
                  ...
                  <?php
                      $query = "SELECT * FROM lecturers ORDER BY ID DESC LIMIT 5";
                      $rs = $conn->query($query);
                      $num = $rs->num_rows;
                      $sn=0;
                      $status="";
