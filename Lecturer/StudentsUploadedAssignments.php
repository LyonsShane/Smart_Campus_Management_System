       ...
       <?php include "Includes/topbar.php";?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Students Uploaded Assignments</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Students Uploaded Assignments</li>
            </ol>
          </div>
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="table-responsive p-3">
                      <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                        ...
                        <tbody>
                        <?php
$query = "SELECT * FROM uploadedassignments WHERE CourseName = '$lecturerCourse' ORDER BY ID ASC";
$rs = $conn->query($query);
$num = $rs->num_rows;
$sn = 0;
if ($num > 0) { 
