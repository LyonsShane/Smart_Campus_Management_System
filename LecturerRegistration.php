              ...
              <div class="col-lg-12">
                <div class="login-form">
                  <div class="text-center">
                    ...
                    <h1 class="h4 text-gray-900 mb-4">Lecturer Registration</h1>
                  </div>
                  ...
                  if(isset($_POST['Register'])){
                    ...
                    $ret=mysqli_fetch_array($query);
                      ...
                      if($ret > 0){ 
                        ...
                        $query=mysqli_query($conn,"INSERT into lecturers(firstName,lastName,emailAddress,password,phoneNo,Address,Gender,dateCreated) 
    value('$firstName','$lastName','$emailAddress','$sampPass_2','$phoneNo','$Address','$Gender','$dateCreated')");
                  
                        if ($query) {
                          echo "<script>alert('Lecturer Successfully Registered!  Your Password Is - Lecturer123'); window.location.href='Login.php';</script>";
exit();
                      } else {
