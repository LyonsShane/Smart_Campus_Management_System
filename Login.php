          ...
          <div class="card-body p-0">
            <div class="row">
              <div class="col-lg-12">
                ...
                <h5 align="center">SMART CAMPUS MANAGEMENT SYSTEM</h5>
                  <div class="text-center">
                    <img src="img/logo/logo 1.png" style="width:100px;height:100px">
                    <br><br>
...
<?php
  ...
  if(isset($_POST['login'])){
    ...
    if($userType == "Administrator"){
      ...
      $query = "SELECT * FROM lecturers WHERE emailAddress = '$username' AND password = '$password'";
      $rs = $conn->query($query);
      $num = $rs->num_rows;
      $rows = $rs->fetch_assoc();
      ...
      $query = "SELECT * FROM students WHERE emailAddress = '$username' AND password = '$password'";
      $rs = $conn->query($query);
      $num = $rs->num_rows;
      $rows = $rs->fetch_assoc();
