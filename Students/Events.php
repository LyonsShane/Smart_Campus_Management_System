      ...
      <div id="content">
       ...
       <?php include "Includes/topbar.php";?>
        ...
        if (mysqli_num_rows($query1) > 0) {
            while ($events = mysqli_fetch_assoc($query1)) {
        ?>
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col-md-4 mb-2">
                                <div class="text-s font-weight-bold  text-gray-dark mb-1">Event Name</div>
                                <div class="h6 mb-0  text-gray-800"><?php echo htmlspecialchars($events['EventName']); ?></div>
                            </div>
						...
						<div class="col-md-2 mb-2">
                                ...
                                <div class="h6 mb-0  text-gray-800"><?php echo htmlspecialchars($events['Date']); ?></div>
						</div>
                        <br>
						
						<div class="col-md-2 mb-2">
                                <div class="text-s font-weight-bold  text-gray-dark mb-1">Time</div>
                                <div class="h6 mb-0  text-gray-800"><?php echo htmlspecialchars($events['Time']); ?></div>
						</div>
                        <br>
						
						<div class="col-md-2 mb-2">
                                <div class="text-s font-weight-bold  text-gray-dark mb-1">Venue</div>
                                <div class="h6 mb-0  text-gray-800"><?php echo htmlspecialchars($events['Venue']); ?></div>
						</div>
						...
						<div class="col-md-12 mb-2">
                                ...
                                <div class="h6 mb-0  text-gray-800"><?php echo htmlspecialchars($events['Description']); ?></div>
						</div>
                    </div>
                </div>
            </div>
